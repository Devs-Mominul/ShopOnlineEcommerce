                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="middle-right">
                                <ul>
                                    <li><a href="{{ route('index') }}"><i class="fi flaticon-right-and-left"></i><span>Compare</span></a>
                                    </li>
                                    @auth('customer')
                                    ...
                                    <li>
                                        <div class="mini-cart">
                                            <button class="cart-toggle-btn"> <i class="fi flaticon-add-to-cart"></i>
                                                <span class="cart-count">{{ App\Models\card::where('customer_id',Auth::guard('customer')->id())->count() }}</span></button>
                                               ...
                                               <div class="mini-cart-items">
                                                ...
                                                <div class="clearfix mini-cart-action">
                                                    ...
                                                    <span class="mt-5 mini-checkout-price">Subtotal:
                                                        <span>${{ $sub }}</span></span>
                                                    <div class="mini-btn">
                                                        <a href="{{ route('card.shop') }}" class="view-cart-btn">View Cart</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <ul id="metis-menu">
                                            ...
                                            <li class="header-catagory-item">
                                                ...
                                                <ul class="header-catagory-single">
                                                    ...
                                                    <li><a href="{{ route('subcategory_product',$subcategory->id )  }}">{{ $subcategory->subcategory_name }}</a></li>
